...
selection = limit data 10;

result = FOREACH selection GENERATE driverId,truckId,eventTime;

resultOrder = ORDER result BY driverId,truckId,eventTime;

STORE resultOrder INTO 'output/' using PigStorage(',');
